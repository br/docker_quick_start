# Dockerized Ruby on Rails Sample Application
...
by [Michael Hartl](http://michaelhartl.com/).  We dockerized it, so we may use it throughout our [quick start guide on Docker](https://github.com/br/dockerized_hartl/wiki).
